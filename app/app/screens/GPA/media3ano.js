...
export default function Media3ano({ navigation, route }) {
  ...
  function Gradeful() {
    ...
    const mediaFinalGeral = (parseFloat(mediaFinalPortugues) + parseFloat(mediaFinalProducaoTextual) + parseFloat(mediaFinalLiteratura) + parseFloat(mediaFinalEducacaoFisica) + parseFloat(mediaFinalIngles) + parseFloat(mediaFinalHistoria) + parseFloat(mediaFinalGeografia) + parseFloat(mediaFinalFilosofia) + parseFloat(mediaFinalSociologia) + parseFloat(mediaFinalAtualidades) + parseFloat(mediaFinalFisica) + parseFloat(mediaFinalQuimica) + parseFloat(mediaFinalBiologia) + parseFloat(mediaFinalMatematica)) / 14 || 0
            ...
            <View style={styles.inputWrapper}>
              <View style={styles.input}>
                <TextInput
                  ...
                  onChangeText={value => {
                    setMediaFinalLiteratura(value.replace(',', '.'))
                  }}
                />
              </View>
            </View>
            ...
            <View style={styles.inputWrapper}>
              <View style={styles.input}>
                <TextInput
                  ...
                  onChangeText={value => {
                    setMediaFinalSociologia(value.replace(',', '.'))
                  }}
                />
              </View>
            </View>
            ...
            <View style={styles.inputWrapper}>
              <View style={styles.input}>
                <TextInput
                  ...
                  onChangeText={value => {
                    setMediaFinalAtualidades(value.replace(',', '.'))
                  }}
                />
              </View>
            </View>
            ...
            <View style={styles.inputWrapper}>
              <View style={styles.input}>
                <TextInput
                  ...
                  onChangeText={value => {
                    setMediaFinalBiologia(value.replace(',', '.'))
                  }}
                />
              </View>
            </View>
  ...
  function Gradeless() {
    ...
    const mediaFinalGeral = (mediaFinalPortugues+ mediaFinalProducaoTextual+ mediaFinalLiteratura+ mediaFinalArtes+ mediaFinalEducacaoFisica+ mediaFinalIngles+ mediaFinalHistoria+ mediaFinalGeografia+ mediaFinalFilosofia+ mediaFinalSociologia+ mediaFinalAtualidades+ mediaFinalFisica+ mediaFinalQuimica+ mediaFinalBiologia+ mediaFinalMatematica)/ 15 || 0
