...
export default function media3ano() {
	...
	function Gradeful() {
		...
		const mediaFinalGeral =
			(parseFloat(mediaFinalPortugues) +
				parseFloat(mediaFinalProducaoTextual) +
				parseFloat(mediaFinalLiteratura) +
				parseFloat(mediaFinalEducacaoFisica) +
				parseFloat(mediaFinalIngles) +
				parseFloat(mediaFinalHistoria) +
				parseFloat(mediaFinalGeografia) +
				parseFloat(mediaFinalFilosofia) +
				parseFloat(mediaFinalSociologia) +
				parseFloat(mediaFinalAtualidades) +
				parseFloat(mediaFinalFisica) +
				parseFloat(mediaFinalQuimica) +
				parseFloat(mediaFinalBiologia) +
				parseFloat(mediaFinalMatematica)) /
				14 || 0
